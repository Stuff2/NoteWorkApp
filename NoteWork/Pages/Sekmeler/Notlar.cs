...
namespace NoteWork.Pages.Sekmeler
{
    public partial class Notlar : ContentPage
    {
        ...
        public Notlar(Profile yeniProfil,NetWork k)
        {
            ...
            picker.SelectedIndex = picker.Items.IndexOf(k.NetWorks);
            ...
            else if (k.MeetState == notanis.Text)
            {
            ...
            else if (k.MeetState == wanttanis.Text)
            {
				gayagay1.IsVisible = false;
				gayagay2.IsVisible = false;
            ...
            tapGestureRecognizer4.Tapped += async (s, e) => {
                ...
                k.MeetWhen = whenMeet.Text;
                k.MeetWhere = whereMeet.Text;
                k.FirstImpression = firstGlance.Text;
                k.Distinctive = distinctive.Text;
                k.MeetState = bc;
                k.NetWorks = picker.Items[picker.SelectedIndex];

                GirisSayfasi.manager.UpdateNetWork(k);
                await Navigation.PopModalAsync();
